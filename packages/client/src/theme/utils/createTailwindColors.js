...
const palette = {
  ...
  // Soft Daisy teal family (OmicsBase1) — replaces ChatGPT #10a37f green
  green: {
    50: '#edf7f6',
    100: '#d5efec',
    200: '#a8dbd6',
...
function createTailwindColors() {
  return {
    ...
    'status-warning-strong': cssVar('--status-warning-strong'),
    ...
    'status-error-strong': cssVar('--status-error-strong'),
